...
export const IMG_RETRIEVE_BASE_URL = process.env.REACT_APP_IMG_RETRIEVE_BASE_URL==null ?  "http://localhost:3500": process.env.REACT_APP_IMG_RETRIEVE_BASE_URL;//"http://104.154.216.198:3500";
export const API_KEY = rocess.env.REACT_APP_API_KEY;
